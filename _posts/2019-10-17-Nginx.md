...
![工作模式](http://impassive.cdn.cone4.top/1.png)  
...
### 组成部分
    ...
    - location（URL匹配特定位置后的配置）

```
#定义Nginx运行的用户和用户组
user www www;

#nginx进程数，通常设置成和cpu的数量相等(之前图中展示的进程信息)
worker_processes 4;
...
注：以上配置信息来源于掘金：https://juejin.im/post/5c1616186fb9a049a42ef21d
